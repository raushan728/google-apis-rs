...
analyticsadmin1-alpha [options]
        account-summaries
                list [-p <v>]... [-o <out>]
        accounts
                access-bindings-batch-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                access-bindings-batch-delete <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                access-bindings-batch-get <parent> [-p <v>]... [-o <out>]
                access-bindings-batch-update <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                access-bindings-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                access-bindings-delete <name> [-p <v>]... [-o <out>]
                access-bindings-get <name> [-p <v>]... [-o <out>]
                access-bindings-list <parent> [-p <v>]... [-o <out>]
                access-bindings-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                run-access-report <entity> (-r <kv>)... [-p <v>]... [-o <out>]
        ...
        properties
                ...
                ad-sense-links-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                ad-sense-links-delete <name> [-p <v>]... [-o <out>]
                ad-sense-links-get <name> [-p <v>]... [-o <out>]
                ad-sense-links-list <parent> [-p <v>]... [-o <out>]
                audiences-archive <name> (-r <kv>)... [-p <v>]... [-o <out>]
                audiences-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                calculated-metrics-list <parent> [-p <v>]... [-o <out>]
                calculated-metrics-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                channel-groups-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                channel-groups-delete <name> [-p <v>]... [-o <out>]
                channel-groups-get <name> [-p <v>]... [-o <out>]
                channel-groups-list <parent> [-p <v>]... [-o <out>]
                channel-groups-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                data-streams-event-create-rules-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                data-streams-event-create-rules-delete <name> [-p <v>]... [-o <out>]
                ...
                data-streams-s-k-ad-network-conversion-value-schema-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                data-streams-s-k-ad-network-conversion-value-schema-delete <name> [-p <v>]... [-o <out>]
                data-streams-s-k-ad-network-conversion-value-schema-get <name> [-p <v>]... [-o <out>]
                data-streams-s-k-ad-network-conversion-value-schema-list <parent> [-p <v>]... [-o <out>]
                data-streams-s-k-ad-network-conversion-value-schema-patch <name> (-r <kv>)... [-p <v>]... [-o <out>]
                ...
                expanded-data-sets-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                expanded-data-sets-delete <name> [-p <v>]... [-o <out>]
                ...
                rollup-property-source-links-list <parent> [-p <v>]... [-o <out>]
                run-access-report <entity> (-r <kv>)... [-p <v>]... [-o <out>]
                search-ads360-links-create <parent> (-r <kv>)... [-p <v>]... [-o <out>]
                search-ads360-links-delete <name> [-p <v>]... [-o <out>]
