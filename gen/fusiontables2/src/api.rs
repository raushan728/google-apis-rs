...
impl<C> common::Hub for Fusiontables<C> {}

impl<'a, C> Fusiontables<C> {
    ...
    pub fn column(&'a self) -> ColumnMethods<'a, C> {
        ColumnMethods { hub: self }
    }
    pub fn query(&'a self) -> QueryMethods<'a, C> {
        QueryMethods { hub: self }
    }
    pub fn style(&'a self) -> StyleMethods<'a, C> {
        StyleMethods { hub: self }
    }
    pub fn table(&'a self) -> TableMethods<'a, C> {
        TableMethods { hub: self }
    }
    pub fn task(&'a self) -> TaskMethods<'a, C> {
        TaskMethods { hub: self }
    }
    pub fn template(&'a self) -> TemplateMethods<'a, C> {
...
impl common::RequestValue for Column {}
impl common::ResponseResult for Column {}
...
impl common::ResponseResult for ColumnList {}
...
impl common::ResponseResult for Import {}
...
impl common::Part for PolygonStyle {}
...
impl common::ResponseResult for Sqlresponse {}
...
impl common::Part for StyleFunction {}
...
impl common::RequestValue for StyleSetting {}
impl common::ResponseResult for StyleSetting {}
...
impl common::ResponseResult for StyleSettingList {}
...
impl common::RequestValue for Table {}
impl common::ResponseResult for Table {}
...
impl common::ResponseResult for TableList {}
...
impl common::ResponseResult for TemplateList {}
...
impl common::NestedType for ColumnBaseColumn {}
impl common::Part for ColumnBaseColumn {}
...
impl common::NestedType for StyleFunctionGradient {}
impl common::Part for StyleFunctionGradient {}
...
impl common::NestedType for StyleFunctionGradientColors {}
impl common::Part for StyleFunctionGradientColors {}
...
/// # }
/// ```
pub struct ColumnMethods<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
}

impl<'a, C> common::MethodsBuilder for ColumnMethods<'a, C> {}

impl<'a, C> ColumnMethods<'a, C> {
    ...
    pub fn delete(&self, table_id: &str, column_id: &str) -> ColumnDeleteCall<'a, C> {
        ColumnDeleteCall {
            hub: self.hub,
    ...
    pub fn get(&self, table_id: &str, column_id: &str) -> ColumnGetCall<'a, C> {
        ColumnGetCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _column_id: column_id.to_string(),
    ...
    pub fn insert(&self, request: Column, table_id: &str) -> ColumnInsertCall<'a, C> {
        ColumnInsertCall {
            hub: self.hub,
            _request: request,
            _table_id: table_id.to_string(),
    ...
    pub fn list(&self, table_id: &str) -> ColumnListCall<'a, C> {
        ColumnListCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
...
impl<'a, C> QueryMethods<'a, C> {
    ...
    ///           - DESCRIBE
    ///           - CREATE
    pub fn sql(&self, sql: &str) -> QuerySqlCall<'a, C> {
        QuerySqlCall {
            hub: self.hub,
            _sql: sql.to_string(),
    ...
    ///           - SHOW
    ///           - DESCRIBE
    pub fn sql_get(&self, sql: &str) -> QuerySqlGetCall<'a, C> {
        QuerySqlGetCall {
            hub: self.hub,
            _sql: sql.to_string(),
            _typed: Default::default(),
...
impl<'a, C> common::MethodsBuilder for StyleMethods<'a, C> {}

impl<'a, C> StyleMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    /// Deletes a style.
    ///
    ...
    pub fn delete(&self, table_id: &str, style_id: i32) -> StyleDeleteCall<'a, C> {
        StyleDeleteCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _style_id: style_id,
    ...
    pub fn get(&self, table_id: &str, style_id: i32) -> StyleGetCall<'a, C> {
        StyleGetCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _style_id: style_id,
    ...
    pub fn insert(&self, request: StyleSetting, table_id: &str) -> StyleInsertCall<'a, C> {
        StyleInsertCall {
            hub: self.hub,
            _request: request,
            _table_id: table_id.to_string(),
    ...
    pub fn list(&self, table_id: &str) -> StyleListCall<'a, C> {
        StyleListCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _page_token: Default::default(),
...
impl<'a, C> common::MethodsBuilder for TableMethods<'a, C> {}
...
impl<'a, C> TaskMethods<'a, C> {
    ...
    pub fn delete(&self, table_id: &str, task_id: &str) -> TaskDeleteCall<'a, C> {
        TaskDeleteCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
    ...
    pub fn get(&self, table_id: &str, task_id: &str) -> TaskGetCall<'a, C> {
        TaskGetCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _task_id: task_id.to_string(),
    ...
    pub fn list(&self, table_id: &str) -> TaskListCall<'a, C> {
        TaskListCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
...
impl<'a, C> TemplateMethods<'a, C> {
    ...
    pub fn delete(&self, table_id: &str, template_id: i32) -> TemplateDeleteCall<'a, C> {
        TemplateDeleteCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
    ...
    pub fn get(&self, table_id: &str, template_id: i32) -> TemplateGetCall<'a, C> {
        TemplateGetCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _template_id: template_id,
    ...
    pub fn insert(&self, request: Template, table_id: &str) -> TemplateInsertCall<'a, C> {
        TemplateInsertCall {
            hub: self.hub,
            _request: request,
            _table_id: table_id.to_string(),
    ...
    pub fn list(&self, table_id: &str) -> TemplateListCall<'a, C> {
        TemplateListCall {
            hub: self.hub,
            _table_id: table_id.to_string(),
            _page_token: Default::default(),
...
/// # }
/// ```
pub struct ColumnDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for ColumnDeleteCall<'a, C> {}

impl<'a, C> ColumnDeleteCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        for &(find_this, param_name) in
            [("{tableId}", "tableId"), ("{columnId}", "columnId")].iter()
        {
            url = params.uri_replacement(url, param_name, find_this, false);
        }
        {
            let to_remove = ["columnId", "tableId"];
    ...
    pub fn table_id(mut self, new_value: &str) -> ColumnDeleteCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn column_id(mut self, new_value: &str) -> ColumnDeleteCall<'a, C> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnDeleteCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ColumnDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ColumnDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnDeleteCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ColumnGetCall<'a, C> {}

impl<'a, C> ColumnGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Column)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> ColumnGetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn column_id(mut self, new_value: &str) -> ColumnGetCall<'a, C> {
        self._column_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ColumnGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ColumnGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ColumnInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for ColumnInsertCall<'a, C> {}

impl<'a, C> ColumnInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Column) -> ColumnInsertCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> ColumnInsertCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnInsertCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ColumnInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ColumnInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ColumnListCall<'a, C> {}

impl<'a, C> ColumnListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ColumnList)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> ColumnListCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    pub fn page_token(mut self, new_value: &str) -> ColumnListCall<'a, C> {
    ...
    pub fn max_results(mut self, new_value: u32) -> ColumnListCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ColumnListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ColumnListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ColumnPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for ColumnPatchCall<'a, C> {}

impl<'a, C> ColumnPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Column) -> ColumnPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> ColumnPatchCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn column_id(mut self, new_value: &str) -> ColumnPatchCall<'a, C> {
        self._column_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnPatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ColumnPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ColumnPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ColumnUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for ColumnUpdateCall<'a, C> {}

impl<'a, C> ColumnUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Column) -> ColumnUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Table for which the column is being updated.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> ColumnUpdateCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// Name or identifier for the column that is being updated.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn column_id(mut self, new_value: &str) -> ColumnUpdateCall<'a, C> {
        self._column_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ColumnUpdateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ColumnUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ColumnUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ColumnUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ColumnUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for QuerySqlCall<'a, C> {}

impl<'a, C> QuerySqlCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Sqlresponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        if let Some(value) = self._hdrs.as_ref() {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn sql(mut self, new_value: &str) -> QuerySqlCall<'a, C> {
    ...
    pub fn typed(mut self, new_value: bool) -> QuerySqlCall<'a, C> {
    ...
    pub fn hdrs(mut self, new_value: bool) -> QuerySqlCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> QuerySqlCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> QuerySqlCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> QuerySqlCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> QuerySqlCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> QuerySqlCall<'a, C> {
        self._scopes.clear();
        self
    }
...
/// # }
/// ```
pub struct QuerySqlGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for QuerySqlGetCall<'a, C> {}

impl<'a, C> QuerySqlGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn sql(mut self, new_value: &str) -> QuerySqlGetCall<'a, C> {
        self._sql = new_value.to_string();
        self
    }
    /// Whether typed values are returned in the (JSON) response: numbers for numeric values and parsed geometries for KML values. Default is true.
    ///
    /// Sets the *typed* query property to the given value.
    pub fn typed(mut self, new_value: bool) -> QuerySqlGetCall<'a, C> {
        self._typed = Some(new_value);
        self
    }
    /// Whether column names are included (in the first row). Default is true.
    ///
    /// Sets the *hdrs* query property to the given value.
    pub fn hdrs(mut self, new_value: bool) -> QuerySqlGetCall<'a, C> {
        self._hdrs = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> QuerySqlGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> QuerySqlGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> QuerySqlGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> QuerySqlGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
...
/// # }
/// ```
pub struct StyleDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for StyleDeleteCall<'a, C> {}

impl<'a, C> StyleDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StyleDeleteCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn style_id(mut self, new_value: i32) -> StyleDeleteCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StyleDeleteCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StyleDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StyleDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StyleDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StyleDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for StyleGetCall<'a, C> {}

impl<'a, C> StyleGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, StyleSetting)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StyleGetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn style_id(mut self, new_value: i32) -> StyleGetCall<'a, C> {
        self._style_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StyleGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StyleGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StyleGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StyleGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StyleGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct StyleInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for StyleInsertCall<'a, C> {}

impl<'a, C> StyleInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: StyleSetting) -> StyleInsertCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StyleInsertCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StyleInsertCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StyleInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StyleInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StyleInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StyleInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for StyleListCall<'a, C> {}

impl<'a, C> StyleListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, StyleSettingList)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StyleListCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> StyleListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *max results* query property to the given value.
    pub fn max_results(mut self, new_value: u32) -> StyleListCall<'a, C> {
        self._max_results = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StyleListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StyleListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StyleListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StyleListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StyleListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for StylePatchCall<'a, C> {}

impl<'a, C> StylePatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: StyleSetting) -> StylePatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StylePatchCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn style_id(mut self, new_value: i32) -> StylePatchCall<'a, C> {
        self._style_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StylePatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StylePatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StylePatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StylePatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StylePatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct StyleUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for StyleUpdateCall<'a, C> {}

impl<'a, C> StyleUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: StyleSetting) -> StyleUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Table whose style is being updated.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> StyleUpdateCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// Identifier (within a table) for the style being updated.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn style_id(mut self, new_value: i32) -> StyleUpdateCall<'a, C> {
        self._style_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> StyleUpdateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> StyleUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> StyleUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> StyleUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> StyleUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableCopyCall<'a, C> {}

impl<'a, C> TableCopyCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Table)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableCopyCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    pub fn copy_presentation(mut self, new_value: bool) -> TableCopyCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableCopyCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TableCopyCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableCopyCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableCopyCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableCopyCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableDeleteCall<'a, C> {}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableDeleteCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableDeleteCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableGetCall<'a, C> {}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableGetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TableImportRowCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TableImportRowCall<'a, C> {}

impl<'a, C> TableImportRowCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    ) -> common::Result<(common::Response, Import)>
    where
        RS: common::ReadSeek,
    {
        use std::borrow::Cow;
        ...
        if let Some(value) = self._is_strict.as_ref() {
            params.push("isStrict", value.to_string());
        }
        if let Some(value) = self._end_line.as_ref() {
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone()
                    + "resumable/upload/fusiontables/v2/tables/{tableId}/import",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/fusiontables/v2/tables/{tableId}/import",
                "multipart",
            )
        } else {
            unreachable!()
        ...
        loop {
            ...
            let mut req_result = {
                ...
                let request = if protocol == common::UploadProtocol::Simple {
                    ...
                    if size > 262144000 {
                        return Err(common::Error::UploadSizeLimitExceeded(size, 262144000));
                    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableImportRowCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    pub fn start_line(mut self, new_value: i32) -> TableImportRowCall<'a, C> {
    ...
    pub fn is_strict(mut self, new_value: bool) -> TableImportRowCall<'a, C> {
    ...
    pub fn end_line(mut self, new_value: i32) -> TableImportRowCall<'a, C> {
    ...
    pub fn encoding(mut self, new_value: &str) -> TableImportRowCall<'a, C> {
    ...
    pub fn delimiter(mut self, new_value: &str) -> TableImportRowCall<'a, C> {
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TableImportRowCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableImportRowCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableImportRowCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableImportRowCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TableImportTableCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TableImportTableCall<'a, C> {}

impl<'a, C> TableImportTableCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    async fn doit<RS>(
        ...
        reader_mime_type: mime::Mime,
        protocol: common::UploadProtocol,
    ) -> common::Result<(common::Response, Table)>
    where
        RS: common::ReadSeek,
    {
        use std::borrow::Cow;
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone() + "resumable/upload/fusiontables/v2/tables/import",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/fusiontables/v2/tables/import",
                "multipart",
            )
        } else {
            unreachable!()
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn name(mut self, new_value: &str) -> TableImportTableCall<'a, C> {
    ...
    ///
    /// Sets the *encoding* query property to the given value.
    pub fn encoding(mut self, new_value: &str) -> TableImportTableCall<'a, C> {
        self._encoding = Some(new_value.to_string());
        self
    }
    /// The delimiter used to separate cell values. This can only consist of a single character. Default is ,.
    ///
    /// Sets the *delimiter* query property to the given value.
    pub fn delimiter(mut self, new_value: &str) -> TableImportTableCall<'a, C> {
        self._delimiter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TableImportTableCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableImportTableCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableImportTableCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableImportTableCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableInsertCall<'a, C> {}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Table) -> TableInsertCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableInsertCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableListCall<'a, C> {}
...
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TableList)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *page token* query property to the given value.
    pub fn page_token(mut self, new_value: &str) -> TableListCall<'a, C> {
        self._page_token = Some(new_value.to_string());
        self
    }
    ...
    ///
    /// Sets the *max results* query property to the given value.
    pub fn max_results(mut self, new_value: u32) -> TableListCall<'a, C> {
        self._max_results = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TablePatchCall<'a, C> {}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Table) -> TablePatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TablePatchCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    pub fn replace_view_definition(mut self, new_value: bool) -> TablePatchCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TablePatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TablePatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TablePatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TablePatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TableRefetchSheetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TableRefetchSheetCall<'a, C> {}

impl<'a, C> TableRefetchSheetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableRefetchSheetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TableRefetchSheetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableRefetchSheetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableRefetchSheetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableRefetchSheetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TableReplaceRowCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TableReplaceRowCall<'a, C> {}

impl<'a, C> TableReplaceRowCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    async fn doit<RS>(
        ...
        reader_mime_type: mime::Mime,
        protocol: common::UploadProtocol,
    ) -> common::Result<(common::Response, Task)>
    where
        RS: common::ReadSeek,
    {
        use std::borrow::Cow;
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone()
                    + "resumable/upload/fusiontables/v2/tables/{tableId}/replace",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/fusiontables/v2/tables/{tableId}/replace",
                "multipart",
            )
        } else {
            unreachable!()
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableReplaceRowCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The index of the first line from which to start importing, inclusive. Default is 0.
    ///
    /// Sets the *start line* query property to the given value.
    pub fn start_line(mut self, new_value: i32) -> TableReplaceRowCall<'a, C> {
        self._start_line = Some(new_value);
        self
    }
    ...
    ///
    /// Sets the *is strict* query property to the given value.
    pub fn is_strict(mut self, new_value: bool) -> TableReplaceRowCall<'a, C> {
        self._is_strict = Some(new_value);
        self
    }
    /// The index of the line up to which data will be imported. Default is to import the entire file. If endLine is negative, it is an offset from the end of the file; the imported content will exclude the last endLine lines.
    ///
    /// Sets the *end line* query property to the given value.
    pub fn end_line(mut self, new_value: i32) -> TableReplaceRowCall<'a, C> {
        self._end_line = Some(new_value);
        self
    }
    /// The encoding of the content. Default is UTF-8. Use 'auto-detect' if you are unsure of the encoding.
    ///
    /// Sets the *encoding* query property to the given value.
    pub fn encoding(mut self, new_value: &str) -> TableReplaceRowCall<'a, C> {
        self._encoding = Some(new_value.to_string());
        self
    }
    /// The delimiter used to separate cell values. This can only consist of a single character. Default is ,.
    ///
    /// Sets the *delimiter* query property to the given value.
    pub fn delimiter(mut self, new_value: &str) -> TableReplaceRowCall<'a, C> {
        self._delimiter = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TableReplaceRowCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableReplaceRowCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableReplaceRowCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableReplaceRowCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for TableUpdateCall<'a, C> {}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Table) -> TableUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// ID of the table that is being updated.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TableUpdateCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// Whether the view definition is also updated. The specified view definition replaces the existing one. Only a view can be updated with a new definition.
    ///
    /// Sets the *replace view definition* query property to the given value.
    pub fn replace_view_definition(mut self, new_value: bool) -> TableUpdateCall<'a, C> {
        self._replace_view_definition = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TableUpdateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TableUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TableUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TableUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TaskDeleteCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn task_id(mut self, new_value: &str) -> TaskDeleteCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TaskGetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn task_id(mut self, new_value: &str) -> TaskGetCall<'a, C> {
        self._task_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TaskListCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    pub fn start_index(mut self, new_value: u32) -> TaskListCall<'a, C> {
    ...
    ///
    /// Sets the *max results* query property to the given value.
    pub fn max_results(mut self, new_value: u32) -> TaskListCall<'a, C> {
        self._max_results = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in
            [("{tableId}", "tableId"), ("{templateId}", "templateId")].iter()
        {
            url = params.uri_replacement(url, param_name, find_this, false);
        }
        {
            let to_remove = ["templateId", "tableId"];
            params.remove_params(&to_remove);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplateDeleteCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn template_id(mut self, new_value: i32) -> TemplateDeleteCall<'a, C> {
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplateGetCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn template_id(mut self, new_value: i32) -> TemplateGetCall<'a, C> {
        self._template_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplateInsertCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TemplateList)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplateListCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *max results* query property to the given value.
    pub fn max_results(mut self, new_value: u32) -> TemplateListCall<'a, C> {
        self._max_results = Some(new_value);
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
/// # }
/// ```
pub struct TemplatePatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TemplatePatchCall<'a, C> {}

impl<'a, C> TemplatePatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Template) -> TemplatePatchCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplatePatchCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn template_id(mut self, new_value: i32) -> TemplatePatchCall<'a, C> {
        self._template_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TemplatePatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TemplatePatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TemplatePatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TemplatePatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TemplatePatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TemplateUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Fusiontables<C>,
...
impl<'a, C> common::CallBuilder for TemplateUpdateCall<'a, C> {}

impl<'a, C> TemplateUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Template) -> TemplateUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// Table to which the updated template belongs
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn table_id(mut self, new_value: &str) -> TemplateUpdateCall<'a, C> {
        self._table_id = new_value.to_string();
        self
    }
    /// Identifier for the template that is being updated
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn template_id(mut self, new_value: i32) -> TemplateUpdateCall<'a, C> {
        self._template_id = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TemplateUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TemplateUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TemplateUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TemplateUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
