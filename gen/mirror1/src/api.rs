...
impl<C> common::Hub for Mirror<C> {}

impl<'a, C> Mirror<C> {
    pub fn new<A: 'static + common::GetToken>(client: common::Client<C>, auth: A) -> Mirror<C> {
        Mirror {
            client,
            auth: Box::new(auth),
    ...
    pub fn contacts(&'a self) -> ContactMethods<'a, C> {
    ...
    pub fn timeline(&'a self) -> TimelineMethods<'a, C> {
...
impl common::ResponseResult for AttachmentsListResponse {}
...
impl common::Part for AuthToken {}
...
impl common::RequestValue for Contact {}
impl common::Resource for Contact {}
impl common::ResponseResult for Contact {}
...
impl common::ResponseResult for ContactsListResponse {}
...
impl common::ResponseResult for LocationsListResponse {}
...
impl common::Part for MenuValue {}
...
impl common::ResponseResult for SubscriptionsListResponse {}
...
impl common::RequestValue for TimelineItem {}
impl common::ResponseResult for TimelineItem {}
...
impl common::ResponseResult for TimelineListResponse {}
...
impl common::Part for UserAction {}
...
impl<'a, C> common::MethodsBuilder for ContactMethods<'a, C> {}

impl<'a, C> ContactMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    /// Deletes a contact.
    ///
    ...
    pub fn delete(&self, id: &str) -> ContactDeleteCall<'a, C> {
        ContactDeleteCall {
            hub: self.hub,
            _id: id.to_string(),
            _delegate: Default::default(),
    ...
    ///
    /// * `id` - The ID of the contact.
    pub fn get(&self, id: &str) -> ContactGetCall<'a, C> {
        ContactGetCall {
            hub: self.hub,
            _id: id.to_string(),
            _delegate: Default::default(),
    ...
    ///
    /// * `request` - No description provided.
    pub fn insert(&self, request: Contact) -> ContactInsertCall<'a, C> {
        ContactInsertCall {
            hub: self.hub,
            _request: request,
            _delegate: Default::default(),
    ...
    pub fn list(&self) -> ContactListCall<'a, C> {
        ContactListCall {
            hub: self.hub,
            _delegate: Default::default(),
            _additional_params: Default::default(),
    ...
    /// * `request` - No description provided.
    /// * `id` - The ID of the contact.
    pub fn patch(&self, request: Contact, id: &str) -> ContactPatchCall<'a, C> {
        ContactPatchCall {
            hub: self.hub,
            _request: request,
            _id: id.to_string(),
    ...
    /// * `request` - No description provided.
    /// * `id` - The ID of the contact.
    pub fn update(&self, request: Contact, id: &str) -> ContactUpdateCall<'a, C> {
        ContactUpdateCall {
            hub: self.hub,
            _request: request,
            _id: id.to_string(),
...
impl<'a, C> LocationMethods<'a, C> {
    ...
    pub fn get(&self, id: &str) -> LocationGetCall<'a, C> {
        LocationGetCall {
            hub: self.hub,
            _id: id.to_string(),
            _delegate: Default::default(),
    ...
    pub fn list(&self) -> LocationListCall<'a, C> {
        LocationListCall {
            hub: self.hub,
            _delegate: Default::default(),
            _additional_params: Default::default(),
...
impl<'a, C> SettingMethods<'a, C> {
    ...
    ///          - locale - The key to the user’s language/locale (BCP 47 identifier) that Glassware should use to render localized content.
    ///          - timezone - The key to the user’s current time zone region as defined in the tz database. Example: America/Los_Angeles.
    pub fn get(&self, id: &str) -> SettingGetCall<'a, C> {
        SettingGetCall {
            hub: self.hub,
            _id: id.to_string(),
            _delegate: Default::default(),
...
impl<'a, C> SubscriptionMethods<'a, C> {
    ...
    pub fn list(&self) -> SubscriptionListCall<'a, C> {
    ...
    /// * `request` - No description provided.
    /// * `id` - The ID of the subscription.
    pub fn update(&self, request: Subscription, id: &str) -> SubscriptionUpdateCall<'a, C> {
...
/// # }
/// ```
pub struct TimelineMethods<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::MethodsBuilder for TimelineMethods<'a, C> {}
...
/// # }
/// ```
pub struct AccountInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for AccountInsertCall<'a, C> {}

impl<'a, C> AccountInsertCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Account)> {
        ...
        let mut url =
            self.hub._base_url.clone() + "accounts/{userToken}/{accountType}/{accountName}";
        ...
        {
            let to_remove = ["accountName", "accountType", "userToken"];
    ...
    pub fn request(mut self, new_value: Account) -> AccountInsertCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn user_token(mut self, new_value: &str) -> AccountInsertCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn account_type(mut self, new_value: &str) -> AccountInsertCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn account_name(mut self, new_value: &str) -> AccountInsertCall<'a, C> {
    ...
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> AccountInsertCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> AccountInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
...
/// # }
/// ```
pub struct ContactDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for ContactDeleteCall<'a, C> {}

impl<'a, C> ContactDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::GlasTimeline.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> ContactDeleteCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactDeleteCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ContactDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactDeleteCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ContactDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
impl<'a, C> common::CallBuilder for ContactGetCall<'a, C> {}

impl<'a, C> ContactGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, Contact)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> ContactGetCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ContactGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ContactGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ContactInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for ContactInsertCall<'a, C> {}

impl<'a, C> ContactInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Contact) -> ContactInsertCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactInsertCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ContactInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ContactInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ContactListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for ContactListCall<'a, C> {}

impl<'a, C> ContactListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ContactsListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ContactListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ContactListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ContactPatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for ContactPatchCall<'a, C> {}

impl<'a, C> ContactPatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Contact) -> ContactPatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The ID of the contact.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> ContactPatchCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactPatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactPatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ContactPatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactPatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ContactPatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ContactUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for ContactUpdateCall<'a, C> {}

impl<'a, C> ContactUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Contact) -> ContactUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The ID of the contact.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> ContactUpdateCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> ContactUpdateCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> ContactUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ContactUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ContactUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ContactUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
    ...
    C: common::Connector,
{
    ...
    pub async fn doit(mut self) -> common::Result<(common::Response, Location)> {
        ...
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::GlasLocation.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> LocationGetCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, LocationsListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    C: common::Connector,
{
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> SettingGetCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
...
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SubscriptionsListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
...
/// # }
/// ```
pub struct SubscriptionUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for SubscriptionUpdateCall<'a, C> {}

impl<'a, C> SubscriptionUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Subscription) -> SubscriptionUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The ID of the subscription.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> SubscriptionUpdateCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> SubscriptionUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> SubscriptionUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> SubscriptionUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> SubscriptionUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineAttachmentDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineAttachmentDeleteCall<'a, C> {}

impl<'a, C> TimelineAttachmentDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<common::Response> {
        ...
        #[allow(clippy::single_element_loop)]
        for &(find_this, param_name) in
            [("{itemId}", "itemId"), ("{attachmentId}", "attachmentId")].iter()
        {
            url = params.uri_replacement(url, param_name, find_this, false);
        }
        {
            let to_remove = ["attachmentId", "itemId"];
            params.remove_params(&to_remove);
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn item_id(mut self, new_value: &str) -> TimelineAttachmentDeleteCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn attachment_id(mut self, new_value: &str) -> TimelineAttachmentDeleteCall<'a, C> {
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineAttachmentDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineAttachmentDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineAttachmentDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineAttachmentDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineAttachmentGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineAttachmentGetCall<'a, C> {}

impl<'a, C> TimelineAttachmentGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn item_id(mut self, new_value: &str) -> TimelineAttachmentGetCall<'a, C> {
        self._item_id = new_value.to_string();
        self
    }
    /// The ID of the attachment.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn attachment_id(mut self, new_value: &str) -> TimelineAttachmentGetCall<'a, C> {
        self._attachment_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineAttachmentGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineAttachmentGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineAttachmentGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineAttachmentGetCall<'a, C> {
        self._scopes.clear();
        self
    }
    ...
    pub fn range(mut self, value: impl Into<String>) -> TimelineAttachmentGetCall<'a, C> {
...
/// # }
/// ```
pub struct TimelineAttachmentInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineAttachmentInsertCall<'a, C> {}

impl<'a, C> TimelineAttachmentInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone()
                    + "resumable/upload/mirror/v1/timeline/{itemId}/attachments",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/mirror/v1/timeline/{itemId}/attachments",
                "multipart",
            )
        } else {
            unreachable!()
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn item_id(mut self, new_value: &str) -> TimelineAttachmentInsertCall<'a, C> {
        self._item_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineAttachmentInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineAttachmentInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineAttachmentInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineAttachmentInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineAttachmentListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineAttachmentListCall<'a, C> {}

impl<'a, C> TimelineAttachmentListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, AttachmentsListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn item_id(mut self, new_value: &str) -> TimelineAttachmentListCall<'a, C> {
        self._item_id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineAttachmentListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineAttachmentListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineAttachmentListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineAttachmentListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineDeleteCall<'a, C> {}

impl<'a, C> TimelineDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> TimelineDeleteCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineGetCall<'a, C> {}

impl<'a, C> TimelineGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TimelineItem)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> TimelineGetCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TimelineGetCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineInsertCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineInsertCall<'a, C> {}

impl<'a, C> TimelineInsertCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    async fn doit<RS>(
        ...
        reader_mime_type: mime::Mime,
        protocol: common::UploadProtocol,
    ) -> common::Result<(common::Response, TimelineItem)>
    where
        RS: common::ReadSeek,
    {
        use std::borrow::Cow;
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone() + "resumable/upload/mirror/v1/timeline",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/mirror/v1/timeline",
                "multipart",
            )
        } else {
            unreachable!()
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TimelineItem) -> TimelineInsertCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineInsertCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineInsertCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineInsertCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineInsertCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineListCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineListCall<'a, C> {}

impl<'a, C> TimelineListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, TimelineListResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        if let Some(value) = self._source_item_id.as_ref() {
            params.push("sourceItemId", value);
        }
        if let Some(value) = self._pinned_only.as_ref() {
        ...
        if let Some(value) = self._bundle_id.as_ref() {
            params.push("bundleId", value);
        }
    ...
    pub fn source_item_id(mut self, new_value: &str) -> TimelineListCall<'a, C> {
    ...
    pub fn pinned_only(mut self, new_value: bool) -> TimelineListCall<'a, C> {
    ...
    pub fn page_token(mut self, new_value: &str) -> TimelineListCall<'a, C> {
    ...
    pub fn order_by(mut self, new_value: &str) -> TimelineListCall<'a, C> {
    ...
    pub fn max_results(mut self, new_value: u32) -> TimelineListCall<'a, C> {
    ...
    pub fn include_deleted(mut self, new_value: bool) -> TimelineListCall<'a, C> {
    ...
    pub fn bundle_id(mut self, new_value: &str) -> TimelineListCall<'a, C> {
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TimelineListCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelinePatchCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelinePatchCall<'a, C> {}

impl<'a, C> TimelinePatchCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TimelineItem) -> TimelinePatchCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The ID of the timeline item.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> TimelinePatchCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    ///
    /// Sets the *delegate* property to the given value.
    pub fn delegate(mut self, new_value: &'a mut dyn common::Delegate) -> TimelinePatchCall<'a, C> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelinePatchCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelinePatchCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelinePatchCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelinePatchCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct TimelineUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a Mirror<C>,
...
impl<'a, C> common::CallBuilder for TimelineUpdateCall<'a, C> {}

impl<'a, C> TimelineUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
        ...
        RS: common::ReadSeek,
    {
        ...
        let (mut url, upload_type) = if protocol == common::UploadProtocol::Resumable {
            (
                self.hub._root_url.clone() + "resumable/upload/mirror/v1/timeline/{id}",
                "resumable",
            )
        } else if protocol == common::UploadProtocol::Simple {
            (
                self.hub._root_url.clone() + "upload/mirror/v1/timeline/{id}",
                "multipart",
            )
        } else {
            unreachable!()
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: TimelineItem) -> TimelineUpdateCall<'a, C> {
        self._request = new_value;
        self
    }
    /// The ID of the timeline item.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> TimelineUpdateCall<'a, C> {
        self._id = new_value.to_string();
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *quotaUser* (query-string) - An opaque string that represents a user for quota purposes. Must not exceed 40 characters.
    /// * *userIp* (query-string) - Deprecated. Please use quotaUser instead.
    pub fn param<T>(mut self, name: T, value: T) -> TimelineUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> TimelineUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> TimelineUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> TimelineUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
