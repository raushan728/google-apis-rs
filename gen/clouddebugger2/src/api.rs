...
/// # async fn dox() {
/// use clouddebugger2::{CloudDebugger, FieldMask, hyper_rustls, hyper_util, yup_oauth2};
///
...
///         .build()
/// );
/// let mut hub = CloudDebugger::new(client, auth);
...
impl<C> common::Hub for CloudDebugger<C> {}

impl<'a, C> CloudDebugger<C> {
    ...
    pub fn controller(&'a self) -> ControllerMethods<'a, C> {
        ControllerMethods { hub: self }
    }
    pub fn debugger(&'a self) -> DebuggerMethods<'a, C> {
...
pub struct Breakpoint {
    ...
    pub canary_expire_time: Option<chrono::DateTime<chrono::offset::Utc>>,
    ...
    pub final_time: Option<chrono::DateTime<chrono::offset::Utc>>,
...
impl common::RequestValue for Breakpoint {}
...
impl common::Part for CloudWorkspaceId {}
...
impl common::Part for CloudWorkspaceSourceContext {}
...
impl common::Part for ExtendedSourceContext {}
...
impl common::Part for FormatMessage {}
...
impl common::ResponseResult for GetBreakpointResponse {}
...
impl common::ResponseResult for ListActiveBreakpointsResponse {}
...
impl common::ResponseResult for ListBreakpointsResponse {}
...
impl common::ResponseResult for ListDebuggeesResponse {}
...
impl common::RequestValue for RegisterDebuggeeRequest {}
...
impl common::ResponseResult for RegisterDebuggeeResponse {}
...
impl common::ResponseResult for SetBreakpointResponse {}
...
impl common::Part for StatusMessage {}
...
impl common::RequestValue for UpdateActiveBreakpointRequest {}
...
impl common::ResponseResult for UpdateActiveBreakpointResponse {}
...
/// # }
/// ```
pub struct ControllerMethods<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
}

impl<'a, C> common::MethodsBuilder for ControllerMethods<'a, C> {}

impl<'a, C> ControllerMethods<'a, C> {
    ...
    pub fn debuggees_breakpoints_list(
        &self,
        debuggee_id: &str,
    ) -> ControllerDebuggeeBreakpointListCall<'a, C> {
    ...
    pub fn debuggees_breakpoints_update(
        &self,
        request: UpdateActiveBreakpointRequest,
        debuggee_id: &str,
        id: &str,
    ) -> ControllerDebuggeeBreakpointUpdateCall<'a, C> {
    ...
    ///
    /// * `request` - No description provided.
    pub fn debuggees_register(
        &self,
        request: RegisterDebuggeeRequest,
    ) -> ControllerDebuggeeRegisterCall<'a, C> {
...
/// # }
/// ```
pub struct DebuggerMethods<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::MethodsBuilder for DebuggerMethods<'a, C> {}

impl<'a, C> DebuggerMethods<'a, C> {
    /// Create a builder to help you perform the following task:
    ///
    ...
    pub fn debuggees_breakpoints_delete(
        ...
        debuggee_id: &str,
        breakpoint_id: &str,
    ) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C> {
    ...
    pub fn debuggees_breakpoints_get(
        ...
        debuggee_id: &str,
        breakpoint_id: &str,
    ) -> DebuggerDebuggeeBreakpointGetCall<'a, C> {
    ...
    pub fn debuggees_breakpoints_list(
        &self,
        debuggee_id: &str,
    ) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
    ...
    pub fn debuggees_breakpoints_set(
        ...
        request: Breakpoint,
        debuggee_id: &str,
    ) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
    ...
    pub fn debuggees_list(&self) -> DebuggerDebuggeeListCall<'a, C> {
...
/// # }
/// ```
pub struct ControllerDebuggeeBreakpointListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for ControllerDebuggeeBreakpointListCall<'a, C> {}

impl<'a, C> ControllerDebuggeeBreakpointListCall<'a, C>
where
    C: common::Connector,
{
    ...
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, ListActiveBreakpointsResponse)> {
        use std::borrow::Cow;
        ...
        let mut url =
            self.hub._base_url.clone() + "v2/controller/debuggees/{debuggeeId}/breakpoints";
    ...
    pub fn debuggee_id(mut self, new_value: &str) -> ControllerDebuggeeBreakpointListCall<'a, C> {
    ...
    pub fn wait_token(mut self, new_value: &str) -> ControllerDebuggeeBreakpointListCall<'a, C> {
    ...
    pub fn agent_id(mut self, new_value: &str) -> ControllerDebuggeeBreakpointListCall<'a, C> {
    ...
    pub fn param<T>(mut self, name: T, value: T) -> ControllerDebuggeeBreakpointListCall<'a, C>
    where
        T: AsRef<str>,
    {
    ...
    pub fn add_scope<St>(mut self, scope: St) -> ControllerDebuggeeBreakpointListCall<'a, C>
    where
        St: AsRef<str>,
    {
    ...
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ControllerDebuggeeBreakpointListCall<'a, C>
    where
    ...
    /// for details).
    pub fn clear_scopes(mut self) -> ControllerDebuggeeBreakpointListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ControllerDebuggeeBreakpointUpdateCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for ControllerDebuggeeBreakpointUpdateCall<'a, C> {}

impl<'a, C> ControllerDebuggeeBreakpointUpdateCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(
        mut self,
    ) -> common::Result<(common::Response, UpdateActiveBreakpointResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v2/controller/debuggees/{debuggeeId}/breakpoints/{id}";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    pub fn request(
        mut self,
        new_value: UpdateActiveBreakpointRequest,
    ) -> ControllerDebuggeeBreakpointUpdateCall<'a, C> {
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn debuggee_id(mut self, new_value: &str) -> ControllerDebuggeeBreakpointUpdateCall<'a, C> {
        self._debuggee_id = new_value.to_string();
        self
    }
    /// Breakpoint identifier, unique in the scope of the debuggee.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn id(mut self, new_value: &str) -> ControllerDebuggeeBreakpointUpdateCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ControllerDebuggeeBreakpointUpdateCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ControllerDebuggeeBreakpointUpdateCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ControllerDebuggeeBreakpointUpdateCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ControllerDebuggeeBreakpointUpdateCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct ControllerDebuggeeRegisterCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for ControllerDebuggeeRegisterCall<'a, C> {}

impl<'a, C> ControllerDebuggeeRegisterCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, RegisterDebuggeeResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn request(
        mut self,
        new_value: RegisterDebuggeeRequest,
    ) -> ControllerDebuggeeRegisterCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> ControllerDebuggeeRegisterCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> ControllerDebuggeeRegisterCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> ControllerDebuggeeRegisterCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> ControllerDebuggeeRegisterCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct DebuggerDebuggeeBreakpointDeleteCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for DebuggerDebuggeeBreakpointDeleteCall<'a, C> {}

impl<'a, C> DebuggerDebuggeeBreakpointDeleteCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn debuggee_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C> {
        self._debuggee_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn breakpoint_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DebuggerDebuggeeBreakpointDeleteCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct DebuggerDebuggeeBreakpointGetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for DebuggerDebuggeeBreakpointGetCall<'a, C> {}

impl<'a, C> DebuggerDebuggeeBreakpointGetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, GetBreakpointResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn debuggee_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointGetCall<'a, C> {
        self._debuggee_id = new_value.to_string();
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn breakpoint_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointGetCall<'a, C> {
        self._breakpoint_id = new_value.to_string();
        self
    }
    /// Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
    ///
    /// Sets the *client version* query property to the given value.
    pub fn client_version(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointGetCall<'a, C> {
        self._client_version = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> DebuggerDebuggeeBreakpointGetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DebuggerDebuggeeBreakpointGetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DebuggerDebuggeeBreakpointGetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DebuggerDebuggeeBreakpointGetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct DebuggerDebuggeeBreakpointListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for DebuggerDebuggeeBreakpointListCall<'a, C> {}

impl<'a, C> DebuggerDebuggeeBreakpointListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListBreakpointsResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn debuggee_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
        self._debuggee_id = new_value.to_string();
        self
    }
    ...
    ///
    /// Sets the *wait token* query property to the given value.
    pub fn wait_token(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
        self._wait_token = Some(new_value.to_string());
        self
    }
    ...
    pub fn strip_results(mut self, new_value: bool) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
    ...
    ///
    /// Sets the *client version* query property to the given value.
    pub fn client_version(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
        self._client_version = Some(new_value.to_string());
        self
    }
    ...
    pub fn action_value(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> DebuggerDebuggeeBreakpointListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DebuggerDebuggeeBreakpointListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DebuggerDebuggeeBreakpointListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DebuggerDebuggeeBreakpointListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct DebuggerDebuggeeBreakpointSetCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for DebuggerDebuggeeBreakpointSetCall<'a, C> {}

impl<'a, C> DebuggerDebuggeeBreakpointSetCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, SetBreakpointResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
        ...
        params.push("alt", "json");
        let mut url =
            self.hub._base_url.clone() + "v2/debugger/debuggees/{debuggeeId}/breakpoints/set";
        if self._scopes.is_empty() {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string());
        }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn request(mut self, new_value: Breakpoint) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
        self._request = new_value;
        self
    }
    ...
    /// Even though the property as already been set when instantiating this call,
    /// we provide this method for API completeness.
    pub fn debuggee_id(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
        self._debuggee_id = new_value.to_string();
        self
    }
    /// Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
    ///
    /// Sets the *client version* query property to the given value.
    pub fn client_version(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
        self._client_version = Some(new_value.to_string());
        self
    }
    ...
    pub fn canary_option(mut self, new_value: &str) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> DebuggerDebuggeeBreakpointSetCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DebuggerDebuggeeBreakpointSetCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DebuggerDebuggeeBreakpointSetCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DebuggerDebuggeeBreakpointSetCall<'a, C> {
        self._scopes.clear();
        self
    }
}
...
/// # }
/// ```
pub struct DebuggerDebuggeeListCall<'a, C>
where
    C: 'a,
{
    hub: &'a CloudDebugger<C>,
...
impl<'a, C> common::CallBuilder for DebuggerDebuggeeListCall<'a, C> {}

impl<'a, C> DebuggerDebuggeeListCall<'a, C>
where
    C: common::Connector,
{
    /// Perform the operation you have build so far.
    pub async fn doit(mut self) -> common::Result<(common::Response, ListDebuggeesResponse)> {
        use std::borrow::Cow;
        use std::io::{Read, Seek};
    ...
    pub fn project(mut self, new_value: &str) -> DebuggerDebuggeeListCall<'a, C> {
    ...
    ///
    /// Sets the *include inactive* query property to the given value.
    pub fn include_inactive(mut self, new_value: bool) -> DebuggerDebuggeeListCall<'a, C> {
        self._include_inactive = Some(new_value);
        self
    }
    /// Required. The client version making the call. Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
    ///
    /// Sets the *client version* query property to the given value.
    pub fn client_version(mut self, new_value: &str) -> DebuggerDebuggeeListCall<'a, C> {
        self._client_version = Some(new_value.to_string());
        self
    }
    /// The delegate implementation is consulted whenever there is an intermediate result, or if something goes wrong
    ...
    /// * *uploadType* (query-string) - Legacy upload protocol for media (e.g. "media", "multipart").
    /// * *upload_protocol* (query-string) - Upload protocol for media (e.g. "raw", "multipart").
    pub fn param<T>(mut self, name: T, value: T) -> DebuggerDebuggeeListCall<'a, C>
    where
        T: AsRef<str>,
    {
        self._additional_params
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<St>(mut self, scope: St) -> DebuggerDebuggeeListCall<'a, C>
    where
        St: AsRef<str>,
    {
        self._scopes.insert(String::from(scope.as_ref()));
    ...
    ///
    /// See [`Self::add_scope()`] for details.
    pub fn add_scopes<I, St>(mut self, scopes: I) -> DebuggerDebuggeeListCall<'a, C>
    where
        I: IntoIterator<Item = St>,
        St: AsRef<str>,
    {
    ...
    /// In this case, you have to specify your API-key using the `key` parameter (see [`Self::param()`]
    /// for details).
    pub fn clear_scopes(mut self) -> DebuggerDebuggeeListCall<'a, C> {
        self._scopes.clear();
        self
    }
}
